...
- **Bag of Words (BoW)**  
  ![BoW Accuracy](Accuracy%20Comparison%20for%20BoW.png)

- **TF-IDF**  
  ![TF-IDF Accuracy](Accuracy%20Comparison%20for%20TF-IDF.png)

- **Word2Vec**  
  ![Word2Vec Accuracy](Accuracy%20Comparison%20for%20Word2Vec.png)
